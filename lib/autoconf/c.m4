...
#  The following two macros are backported from 2.6.
...
#
# Note backport from autconf 2.60, no longer required after an update
# to that version, in that case use AC_PROG_CC_C99.
